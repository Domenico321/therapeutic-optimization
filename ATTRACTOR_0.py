# -*- coding: utf-8 -*-
"""
Created on Sun Oct 23 09:40:29 2022

@author: Utente
"""
# This code calculates the attractors of the network in which no silencing 
# intervention has been performed on any gene. Use data from the excel file 
# "Supplementary Table S2" sheet " Attractor_0".
...
#Save the result
model.save_states('attractor_0.xls')