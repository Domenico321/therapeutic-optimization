# -*- coding: utf-8 -*-
"""
Created on Sun Oct 23 11:36:49 2022

@author: Utente
"""
# This code calculates the attractors of the network in which the 
# STAT5A, HIF1A, BRCA1 genes have been constantly silenced (set to zero). 
# Use the data from the excel file "Supplementary Table S2" sheet "Attractor_2".
...
STAT5A* = STAT5A
CD82* = TP53 or HIF1A
TP53* =  (YWHAB or TP53 or CREB1 or NFKB1 or E2F1 or HIF1A or STAT1 or BRCA1 or ETS1 or PML or PLK2 or IRF9 or IFI16 or RELA or BID or REL) and (not HSP90AB1) and not ( HDAC1 or  STAT3 or  CSNK2B or  PARP1 or  EZH2 or  ARRB1 or  PSMD4 or  PLAU or  BCL2L1 or  BCL6 or  SETDB1 or  EEF1G or  UBE2D1 or  WWP1 or  TRIM29 or  MTA1 or  BCL2 or  DAXX)
PLK2* = TP53
CTSD* = TP53 or CTSD
KRT15* = TP53
...
#Save the result
model.save_states('attractor_2.xls')